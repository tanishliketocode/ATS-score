@echo off
REM ============================================================
REM  Converts FastAPI-Interview-Prep.html into a real PDF
REM  using the copy of Edge or Chrome already on this machine.
REM  Just double-click this file.
REM ============================================================

setlocal
set "SRC=%~dp0FastAPI-Interview-Prep.html"
set "OUT=%~dp0FastAPI-Interview-Prep.pdf"
...
if not defined BROWSER (
  ...
  echo.
  echo Open FastAPI-Interview-Prep.html in any browser instead,
